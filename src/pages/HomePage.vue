  ...
  <q-page>
    ...
    <footer>
      <div class="left">
        ...
        <span>© 2025 RADIN. All rights reserved.</span>
      </div>
      <div class="right">
        <q-btn flat label="Terms" no-caps />
        <q-btn flat label="Privacy" no-caps />
        <q-btn flat label="Contact" no-caps />
      </div>
    </footer>
  </q-page>
</template>
...
.badges .badge {
  ...
  border: solid 1px rgb(6 78 59 / 0.5);
